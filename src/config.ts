...
export const DB_COLLECTION_STAKING_SNAPSHOT =
  process.env.DB_COLLECTION_STAKING_SNAPSHOT;
export const DB_COLLECTION_SNAP_CONFIG_BALANCE =
  process.env.DB_COLLECTION_SNAP_CONFIG_BALANCE;
export const DB_COLLECTION_SNAP_HODL_CONFIG =
  process.env.DB_COLLECTION_SNAP_HODL_CONFIG;
...
const envVariables = [
  ...
  {
    name: "DB_COLLECTION_STAKING_SNAPSHOT",
    value: DB_COLLECTION_STAKING_SNAPSHOT,
  },
  {
    name: "DB_COLLECTION_SNAP_CONFIG_BALANCE",
    value: DB_COLLECTION_SNAP_CONFIG_BALANCE,
  },
...
envVariables.forEach((envVar) => {
  if (!envVar.value) {
    throw new Error(
      `${envVar.name} is not set. Please set this environment variable.`
    );
  }
});
